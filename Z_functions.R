...
check_nodes_france <- function(osm_table){
  ...
  points$france <- ifelse(points$id_square_100 %in% france_100 | points$id_square_1000 %in% france_1000 | points$id_square_10000 %in% france_10000,1,0)
